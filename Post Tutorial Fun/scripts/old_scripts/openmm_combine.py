...
if __name__ == '__main__':
    ...
    # Input Files
    psf_liquid = CharmmPsfFile(files['psf_liquid'])
    pdb_liquid = PDBFile(files['pdb_liquid'])
    psf_surface = CharmmPsfFile(files['psf_surface'])
    pdb_surface = PDBFile(files['pdb_surface'])
    ...
    modeller = Modeller(psf_liquid.topology, pdb_liquid.positions)
    modeller.add(psf_surface.topology, pdb_surface.positions)
