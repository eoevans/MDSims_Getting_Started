...
if __name__ == '__main__':
    ...
    forcefield = ForceField('charmm36.xml', 'charmm36/tip4pew.xml.xml')
    ...
    #system = psf.createSystem(ff, nonbondedMethod=nonbondedMethod,nonbondedCutoff=nonbondedCutoff, constraints=constraints, 
    #                          rigidWater=rigidWater, ewaldErrorTolerance=ewaldErrorTolerance)
    pdb.topology.setUnitCellDimensions([(params['x_len']/10), (params['y_len']/10), ((params['z_len']+surface_dims[2])/10)])
